            ...
            <Flex w="100%" my="6"maxWidth={1480} mx="auto" px="6">
                ...
                <Box flex="1" borderRadius={8} bg="gray.800" p="8">
                    <Flex mb="8" justify="space-between" align="center">
                        ...
                        <Link href="/users/creat" passHref>
                            <Button
                            as="a"
                            size="sm"
                            fontSize="sm"
                        ...
                        <Table colorScheme="whiteAlpha" >
                            ...
                            <Tbody>
                                <Tr>
                                    ...
                                    <Td>
                                        <Box>
                                            <Text fontWeight="bold" >Ingrid Larissa</Text>
                                            <Text fontSize="sm" color="gray.300">Larissaorcx@gmail.com</Text>
                                        </Box>
                                    </Td>
                                    {isWideVersion && <Td>01 Janeiro, 2021</Td>}
                                    <Td>
                                        <Button
                                        as="a"
                                        size="sm"
